...
const productPath = `/antd-pro-components@${version}/build/docs/`;
...
export default defineConfig({
  ...
  chainWebpack(memo) {
    ...
    memo.resolve.alias.set('antd-pro-components', join(__dirname, '../src'));
  },
  ...
  alias: {
    ...
    'antd-pro-components': join(__dirname, '../src'),
  },
  apiParser: {
    propFilter: (prop) => {
