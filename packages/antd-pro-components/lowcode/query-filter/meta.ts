...
const QueryFilterMeta: IPublicTypeComponentMetadata = {
    ...
    "props": [
      ...
      },
      {
        "title": {
          ...
          "tip": "defaultColsNumber | @name 默认一行显示几个表单项"
        },
        "name": "defaultColsNumber",
        "description": "@name 默认一行显示几个表单项",
        "setter": {
          "componentName": "NumberSetter",
          "isRequired": false,
          "initialValue": 0
      ...
      },
      {
        "title": {
          "label": {
            "type": "i18n",
            "en-US": "submitterColSpanProps",
            "zh-CN": "submitterColSpanProps"
          }
        },
        "name": "submitterColSpanProps",
        "setter": {
          "componentName": "ObjectSetter",
          "props": {
            "config": {
