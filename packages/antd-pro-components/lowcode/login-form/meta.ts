...
const LoginFormMeta: IPublicTypeComponentMetadata = {
    ...
    "props": [
      ...
      },
      {
        "title": {
          ...
          "tip": "logo | @name logo 的配置，支持 ReactNode 和 url"
        },
        "name": "logo",
        "description": "@name logo 的配置，支持 ReactNode 和 url",
        "setter": {
          "componentName": "SlotSetter",
          "props": {
            "mode": "node"
      ...
      },
      {
        "title": {
          ...
          "tip": "contentStyle | @name 登录框主表格的样式"
        },
        "name": "contentStyle",
        "description": "@name 登录框主表格的样式",
        "setter": {
      ...
      },
      {
        "title": {
          ...
          "tip": "containerStyle | @name 登录框容器的样式"
        },
        "name": "containerStyle",
        "description": "@name 登录框容器的样式",
        "setter": {
          "componentName": "ObjectSetter",
          "props": {
            "config": {
