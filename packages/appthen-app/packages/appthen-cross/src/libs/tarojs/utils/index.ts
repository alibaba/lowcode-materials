...
const WRAPPER_TYPE_STYLE_REGEX =
  /alignSelf|aspectRatio|border.*|bottom|direction|display|end|left|margin.*|position|right|start|top|zIndex|opacity|elevation/;
...
export const dismemberStyle = (
  style?: StyleProp<ViewStyle>,
): { wrapperStyle: ViewStyle; innerStyle: ViewStyle } => {
