...
export default class Picker extends React.Component {
  ...
  render() {
    ...
    const onChange = (e) => {
      ...
      if (this.props.mode === 'time') {
        const range = [
          ['20', '21', '22', '23', ...getTimeRange(0, 23), '00', '01', '02', '03'],
          ['56', '57', '58', '59', ...getTimeRange(0, 59), '00', '01', '02', '03'],
        ];
    ...
    const getTimeSelector = () => {
      const hourRange = ['20', '21', '22', '23', ...getTimeRange(0, 23), '00', '01', '02', '03'];
      const minRange = ['56', '57', '58', '59', ...getTimeRange(0, 59), '00', '01', '02', '03'];
      return [
        <PickerGroup
          mode="time"
          range={hourRange}
    ...
    return (
      <div className={classNames('taro-picker', this.props.className)}>
        <div onClick={showPicker}>{this.props.children}</div>
