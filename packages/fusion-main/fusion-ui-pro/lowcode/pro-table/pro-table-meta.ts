...
export const ProTableProps = [
  ...
  },
  {
    ...
    setter: {
      ...
      props: {
        setters: ['VariableSetter', 'JsonSetter', 'ExpressionSetter'],
      },
    },
  },
  {
  ...
  },
  {
    ...
    items: [
      ...
      //     componentName: 'MixedSetter',
      //     props: {
      //       setters: ['JsonSetter', 'VariableSetter'],
      //     },
      //   },
      // },
      {
      ...
      // },
      {
        name: 'rowSelection.defaultSelectedRowKeys',
        supportVariable: true,
      ...
      },
      {
        ...
        title: {
          label: '所有选择回调',
          tip: '用户手动选择/取消选择所有行的回调',
        },
        setter: 'FunctionSetter',
      },
      // {
      //   name: 'rowSelection.onSelectAllPages',
      //   title: {
      //     label: '所有选择回调',
      //     tip: '用户手动选择/取消选择所有行的回调',
      //   },
      ...
      // },
      // {
      //   name: 'rowSelection.columnProps',
      //   title: {
      //     label: '选择列props',
      //     tip: '选择列 的props，例如锁列、对齐等，可使用Table.Column 的所有参数',
      //   },
      //   setter: 'FunctionSetter',
      // },
    ],
...
export const proTableMeta: IComponentDescription = {
  ...
  docUrl: '',
  icon:
    'https://img.alicdn.com/imgextra/i4/O1CN01z4HeA61OwhjktJNDW_!!6000000001770-55-tps-56-56.svg',
  devMode: 'proCode',
  group: '精选组件',
  category: '表格类',
  tags: ['业务组件'],
