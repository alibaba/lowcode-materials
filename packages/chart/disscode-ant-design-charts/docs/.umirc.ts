...
const productPath = `/disscode-ant-design-charts@${version}/build/docs/`;
...
export default defineConfig({
  ...
  chainWebpack(memo) {
    ...
    memo.resolve.alias.set('disscode-ant-design-charts', join(__dirname, '../src'));
  },
  ...
  alias: {
    ...
    'disscode-ant-design-charts': join(__dirname, '../src'),
  },
  apiParser: {
    propFilter: (prop) => {
