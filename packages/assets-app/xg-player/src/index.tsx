...
const XgplayertComponent: React.FunctionComponent<XgplayertProps> = (
  props,
  ref,
) => {
  ...
  return <div ref={ref} id="appthen_player" />;
};

const RefExampleComponent = forwardRef(
  XgplayertComponent as ForwardRefRenderFunction<any, XgplayertProps>,
);
