...
const productPath = `/@appthen/react-img-editor@${version}/build/docs/`;
...
export default defineConfig({
  ...
  chainWebpack(memo) {
    ...
    memo.resolve.alias.set('@appthen/react-img-editor', join(__dirname, '../src'));
  },
  ...
  alias: {
    ...
    '@appthen/react-img-editor': join(__dirname, '../src'),
  },
  apiParser: {
    propFilter: (prop) => {
