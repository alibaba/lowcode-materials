...
const ProFormUploadDraggerMeta: IPublicTypeComponentMetadata = {
  "componentName": "ProFormUploadDragger",
  "title": "ProFormUploadDragger",
  "docUrl": "",
  "screenshot": "",
  "devMode": "proCode",
  "npm": {
    "package": "test",
    "version": "0.1.0",
    "exportName": "ProFormUploadDragger",
    "main": "src/index.tsx",
    "destructuring": true,
    "subName": ""
  },
    ...
    "props": [
      {
        "title": {
          ...
          "tip": "fieldProps | @name 设置到控件上的属性"
        },
        "name": "fieldProps",
        "description": "@name 设置到控件上的属性",
        "setter": {
      ...
      },
      {
        "title": {
          ...
          "tip": "placeholder | @name 输入的描述，没有值的时候展示"
        },
        "name": "placeholder",
        "description": "@name 输入的描述，没有值的时候展示",
        "setter": {
          "componentName": "MixedSetter",
          "props": {
            "setters": [
      ...
      },
      {
        "title": {
          ...
          "tip": "secondary | @name 是否是次要控件，只针对 LightFilter 下有效"
        },
        "name": "secondary",
        "description": "@name 是否是次要控件，只针对 LightFilter 下有效",
        "setter": {
      ...
      },
      {
        "title": {
          ...
          "tip": "cacheForSwr | @name 是否使用 swr 来缓存 缓存可能导致数据更新不及时，请谨慎使用，尤其是页面中多个组件 name 相同"
        },
        "name": "cacheForSwr",
        "description": "@name 是否使用 swr 来缓存 缓存可能导致数据更新不及时，请谨慎使用，尤其是页面中多个组件 name 相同",
        "defaultValue": "false",
        "setter": {
          "componentName": "BoolSetter",
          "isRequired": false,
      ...
      },
      {
        "title": {
          ...
          "tip": "disabled | @name disabled=true 时控件不可用"
        },
        "name": "disabled",
        "description": "@name disabled=true 时控件不可用",
        "setter": {
          "componentName": "BoolSetter",
          "isRequired": false,
          "initialValue": false
      ...
      },
      {
        "title": {
          ...
          "tip": "proFieldProps | @name 设置到 ProField 上面的 Props，内部属性"
        },
        "name": "proFieldProps",
        "description": "@name 设置到 ProField 上面的 Props，内部属性",
        "setter": {
          "componentName": "ObjectSetter",
          "props": {
            "config": {
      ...
      },
      {
        "title": {
          ...
          "tip": "footerRender | @name QueryFilter 上的footer"
        },
        "name": "footerRender",
        "description": "@name QueryFilter 上的footer",
        "setter": {
          "componentName": "MixedSetter",
          "props": {
            "setters": [
      ...
      },
      {
        "title": {
          ...
          "tip": "icon | @name 上传文件块的图标"
        },
        "name": "icon",
        "description": "@name 上传文件块的图标",
        "defaultValue": "UploadOutlined",
        "setter": {
          "componentName": "SlotSetter",
          "props": {
            "mode": "node"
      ...
      },
      {
        "title": {
          ...
          "tip": "title | @name 上传文件块的标题"
        },
        "name": "title",
        "description": "@name 上传文件块的标题",
        "defaultValue": "单击或拖动文件到此区域进行上传",
        "setter": {
          "componentName": "SlotSetter",
          "props": {
            "mode": "node"
      ...
      },
      {
        "title": {
          ...
          "tip": "description | @name 上传文件块的说明，比标题小一点，但是字数可以更多"
        },
        "name": "description",
        "description": "@name 上传文件块的说明，比标题小一点，但是字数可以更多",
        "defaultValue": "支持单次或批量上传",
        "setter": {
          "componentName": "SlotSetter",
          "props": {
            "mode": "node"
      ...
      },
      {
        "title": {
          ...
          "tip": "max | @name 最大的文件数量，到达数量之后上传按钮会失效"
        },
        "name": "max",
        "description": "@name 最大的文件数量，到达数量之后上传按钮会失效",
        "setter": {
          "componentName": "NumberSetter",
          "isRequired": false,
          "initialValue": 0
      ...
      },
      {
        "title": {
          ...
          "tip": "value | @name 上传组件的 fileList，为了配合form，改成了这个名字"
        },
        "name": "value",
        "description": "@name 上传组件的 fileList，为了配合form，改成了这个名字",
