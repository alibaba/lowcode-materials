...
const ProFormUploadButtonMeta: IPublicTypeComponentMetadata = {
  "componentName": "ProFormUploadButton",
  "title": "ProFormUploadButton",
  "docUrl": "",
  "screenshot": "",
  "devMode": "proCode",
  "npm": {
    "package": "test",
    "version": "0.1.0",
    "exportName": "ProFormUploadButton",
    "main": "src/index.tsx",
    "destructuring": true,
    "subName": ""
  },
    ...
    "props": [
      ...
      },
      {
        "title": {
          ...
          "tip": "icon | @name 上传文件的图标"
        },
        "name": "icon",
        "description": "@name 上传文件的图标",
      ...
      },
      {
        "title": {
          ...
          "tip": "buttonProps | @name 上传按钮的配置"
        },
        "name": "buttonProps",
        "description": "@name 上传按钮的配置",
        "setter": {
          "componentName": "ObjectSetter",
          "props": {
            "config": {
