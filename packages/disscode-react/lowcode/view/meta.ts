    ...
    supports: {
      ...
      events: [
        ...
        },
        {
          name: 'onMouseDown',
          description: '鼠标按下',
          template: "onMouseDown(e, ${extParams}) {\n  console.log('onMouseDown');\n}",
        },
        {
          name: 'onMouseUp',
          description: '鼠标释放',
          template: "onMouseUp(e, ${extParams}) {\n  console.log('onMouseUp');\n}",
        },
        {
          name: 'onMouseMove',
          description: '鼠标移动',
          template: "onMouseMove(e, ${extParams}) {\n  console.log('onMouseMove');\n}",
        },
        {
          name: 'onMouseEnter',
          description: '鼠标进入',
          template: "onMouseEnter(e, ${extParams}) {\n  console.log('onMouseEnter');\n}",
        },
        {
          name: 'onMouseLeave',
          description: '鼠标离开',
          template: "onMouseLeave(e, ${extParams}) {\n  console.log('onMouseLeave');\n}",
        },
      ],
    },
    component: {
